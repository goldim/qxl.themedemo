...
qx.Class.define("scro34.themedemo.window.Player", {
  ...
  members: {
    ...
    _createControls() {
      this._playlistUrl = qx.util.ResourceManager.getInstance().toUri(
        "scro34/themedemo/playlist.json"
      );
    ...
    _createVolumeControl() {
      var volumeIcon = (this._volumeIcon = new qx.ui.basic.Image(
        scro34.themedemo.IconFactory.getInstance().getIcon("MEDIA_PLAYER_LEVEL_50")
      ).set({ enabled: false }));
