...
qx.Class.define("qxl.themedemo.PlayerWindow",
{
  ...
  members:
  {
    ...
    {
      this._playlistUrl = qx.util.ResourceManager.getInstance().toUri("qxl/themedemo/playlist.json");
    ...
    {
      var volumeIcon = this._volumeIcon = new qx.ui.basic.Image("qxl/themedemo/icon/16/nm-signal-50.png").set({enabled: false});
    ...
    _createPlaylist: function()
    {
      ...
      emptyList.add(new qxl.themedemo.Separator(80));
    ...
    _createInfoBar: function()
    {
      ...
      var btnWikipedia = this._btnWikipedia = new qx.ui.toolbar.Button(null, "qxl/themedemo/icon/16/wikipedia.png").set({
        enabled: false
      });
      ...
      var btnVideo = this._btnVideo = new qx.ui.toolbar.Button(null, "qxl/themedemo/icon/16/youtube.jpg").set({
        enabled: false
      });
